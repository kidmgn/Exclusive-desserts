        ...
        >
          ...
          <div>
            ...
            <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Летнее вдохновение
              <em className="block text-rose-300 italic mt-1">Коллекция вкусов</em>
            </h2>
            <p className="font-['Inter'] text-rose-100/70 text-base leading-relaxed mb-8 max-w-md">
              Каждый сезон приносит новое вдохновение. Наша летняя коллекция воспевает спелые ягоды,
              цветочные настои и нежную сладость сезонных продуктов.
            </p>
          ...
          <div className="relative h-72 lg:h-80">
            ...
            <div className="absolute bottom-4 left-0 bg-white rounded-2xl px-5 py-4 shadow-xl">
              <div className="font-['Inter'] text-xs text-stone-500 uppercase tracking-wider">Цена от</div>
              <div className="font-['Playfair_Display'] text-2xl font-bold text-rose-700">350 ₽</div>
            </div>
          </div>
        </div>
      </div>
